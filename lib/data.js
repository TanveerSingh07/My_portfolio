export const profile = {
  ...
  resumeFile: "/TanveerSinghDhanjalResume.pdf",
  web3formsKey: "f3a1a7cb-3242-4b5c-9bbc-e93990dc7cc6",
  tagline:
...
export const journey = [
  ...
  },
  {
    ...
    detail:
      "Mastered the MERN stack and built real-world projects while completing industry-oriented training in React, Angular, and modern web development through Infosys Springboard.",
  },
  {
    year: "2025 - Present",
    icon: "rocket",
    title: "Professional training & innovation",
    detail:
      "Participating in Agentic AI training and Java Full Stack Development with React at QSpiders, while gaining practical experience through hackathons and coding competitions.",
  },
  {
    year: "2025 – Present",
    icon: "trophy",
    ...
    detail:
      "Serving as Student Coordinator at the Training & Placement Cell, building AI-powered applications, and actively seeking freelance opportunities to create impactful digital products.",
  },
];
...
export const achievements = [
  ...
  },
  {
    ...
    org: "Infosys Springboard • QSpiders • GNDEC",
    detail:
      "Completed and currently pursuing industry-oriented training in React, Angular, Java Full Stack Development, and Agentic AI while continuously strengthening practical development skills.",
    impact: [
      "Completed React & Angular training",
      "Learning Java Full Stack",
      "Exploring Agentic AI",
    ],
    skills: ["React", "Angular", "Java", "Agentic AI"],
  },
  {
    commit: "91af73e",
    year: "2024 – Present",
