...
export const achievements = [
  {
    ...
    org: "GNDEC, Ludhiana",
    detail:
      "Coordinated placement drives and communication between students and the T&P Cell.",
  },
  {
    category: "Leadership",
    ...
    org: "GNDEC, Ludhiana",
    detail:
      "Represented student interests and helped organise technical events and fests.",
  },
  {
    category: "Hackathon",
    ...
    detail:
      "Built under real time pressure alongside a team, from problem statement to working prototype.",
  },
  {
    category: "Hackathon",
    ...
    detail:
      "Repeated hackathon participation sharpened fast prototyping and team collaboration.",
  },
  {
    ...
    org: "Udemy",
    detail:
      "Full-stack fundamentals across the modern web development toolchain.",
  },
  {
    category: "Certification",
    title: "Angular & React",
  ...
  },
  {
    ...
    org: "Infosys Springboard",
    detail:
      "Core Python fundamentals, later applied to scripting and problem-solving.",
  },
];
